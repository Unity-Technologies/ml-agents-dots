...
namespace Unity.AI.MLAgents.Tests.Editor
{
    public class SideChannelTests
    {
        ...
        public void TestIntegerSideChannel()
        {
            ...
            var dictSender = new SideChannel[] {  intSender  };
            var dictReceiver = new SideChannel[]  {  intReceiver  };
        ...
        public void TestRawBytesSideChannel()
        {
            ...
            var dictSender = new SideChannel[]  { strSender  };
            var dictReceiver = new SideChannel[]  { strReceiver  };
        ...
        public void TestFloatPropertiesSideChannel()
        {
            ...
            var dictReceiver =  new SideChannel[] {  propA  };
            var dictSender =  new SideChannel[] {  propB  };
